...
<body class="crm_body_bg" >
    ...
    <nav class="sidebar vertical-scroll  ps-container ps-theme-default ps-active-y">
        ...
        <ul id="sidebar_menu">
            <li class="mm-active">
                <a href="index.php" aria-expanded="false" class="mt-0">
                    <div class="icon_menu">
            ...
            <li class="">
                <a href="addbanners.php" aria-expanded="false">
                    <div class="icon_menu">
                        <img src="img/menu-icon/5.svg" alt="">
                    </div>
            ...
            <li class="">
                <a href="addblogs.php" aria-expanded="false">
                    <div class="icon_menu">
                        <img src="img/menu-icon/5.svg" alt="">
                    </div>
                    <span>Add Blogs</span>
            ...
            <li class="">
                <a href="addtestimonals.php" aria-expanded="false">
                    <div class="icon_menu">
                        <img src="img/menu-icon/5.svg" alt="">
                    </div>
            ...
            <li class="">
                <a href="addprojects.php" aria-expanded="false">
                    <div class="icon_menu">
                        <img src="img/menu-icon/5.svg" alt="">
                    </div>
            ...
            <li class="">
                <a href="addteam.php" aria-expanded="false">
                    <div class="icon_menu">
                        <img src="img/menu-icon/5.svg" alt="">
                    </div>
                    <span>Add Team</span>
            ...
            <li class="">
                <a href="addgallery.php" aria-expanded="false">
                    <div class="icon_menu">
                        <img src="img/menu-icon/5.svg" alt="">
                    </div>
            ...
            <li class="">
                <a href="addcontactinfo.php" aria-expanded="false">
                    <div class="icon_menu">
                        <img src="img/menu-icon/5.svg" alt="">
                    </div>
            ...
            <li class="">
                <a href="addjoinusinfo.php" aria-expanded="false">
                    <div class="icon_menu">
                        <img src="img/menu-icon/5.svg" alt="">
                    </div>
                    <span>Join us Info</span>
                </a>
            </li>
            <li class="">
                <a href="adddonationinfo.php" aria-expanded="false">
                    <div class="icon_menu">
                        <img src="img/menu-icon/5.svg" alt="">
                    </div>
            ...
            <div class="form-group mt-4 mb-4 text-center">
                <a href="#">
<button class="btn btn-light btncol" type="button">Sign out</button>
</a>
</div>
            <!-- <li class="mm-active">
