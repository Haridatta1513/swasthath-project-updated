    ...
    <div class="container-fluid p-0">
        ...
        <div class="col-lg-4">
            ...
            <div class="col-lg-4">
                ...
                <div class="text-center p-5">
                <h1>5</h1>
                <p class="card-font">Testimonals</p>
</div>
                </div>
            </div>
            <div class="col-lg-4">
        ...
        <div class="row">
                ...
                <div class="sales_unit_footer d-flex justify-content-between">
                    <div class="single_sales">
                        ...
                        <p class="d-flex align-items-center">
                            <i class="ti-arrow-up"></i> <span> 14.5%</span> Up From Last Month
                        </p>
                    </div>
            ...
            <div class="col-lg-4">
                ...
                " href="#">Load more <i class="ti-angle-down f_s_12 ml-2"></i>
                            </a>
                        </div>
                    </div>
                </div>
                            ...
                            <table class="table lms_table_active2 p-0">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="f_s_14 f_w_400 text-right">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="customer d-flex align-items-center">
                                                <div class="thumb_34 mr_15 mt-0">
                                                    <img class="img-fluid radius_50" src="img/customers/pro_1.png"
                                                        alt="" />
                                                </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="customer d-flex align-items-center">
                                                <div class="thumb_34 mr_15 mt-0">
                                                    <img class="img-fluid radius_50" src="img/customers/pro_2.png"
                                                        alt="" />
                                                </div>
                                                <span class="f_s_14 f_w_400 color_text_1">Product 1</span>
                                            </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="customer d-flex align-items-center">
                                                <div class="thumb_34 mr_15 mt-0">
                                                    <img class="img-fluid radius_50" src="img/customers/pro_3.png"
                                                        alt="" />
                                                </div>
                                                <span class="f_s_14 f_w_400 color_text_1">Product 1</span>
                                            </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="customer d-flex align-items-center">
                                                <div class="thumb_34 mr_15 mt-0">
                                                    <img class="img-fluid radius_50" src="img/customers/pro_4.png"
                                                        alt="" />
                                                </div>
                                                <span class="f_s_14 f_w_400 color_text_1">Product 1</span>
                                            </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="customer d-flex align-items-center">
                                                <div class="thumb_34 mr_15 mt-0">
                                                    <img class="img-fluid radius_50" src="img/customers/pro_5.png"
                                                        alt="" />
                                                </div>
                                                <span class="f_s_14 f_w_400 color_text_1">Product 1</span>
                                            </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="customer d-flex align-items-center">
                                                <div class="thumb_34 mr_15 mt-0">
                                                    <img class="img-fluid radius_50" src="img/customers/pro_6.png"
                                                        alt="" />
                                                </div>
                                                <span class="f_s_14 f_w_400 color_text_1">Product 1</span>
                                            </div>
                                ...
                                <tbody>
                                        ...
                                        <td>
                                            <div class="customer d-flex align-items-center">
                                                <div class="thumb_62 mr_15 mt-0">
                                                    <img class="img-fluid radius_50" src="img/customers/pro_big.png"
                                                        alt="" />
                                                </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="customer d-flex align-items-center">
                                                <div class="thumb_62 mr_15 mt-0">
                                                    <img class="img-fluid radius_50" src="img/customers/pro_big_1.png"
                                                        alt="" />
                                                </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="customer d-flex align-items-center">
                                                <div class="thumb_62 mr_15 mt-0">
                                                    <img class="img-fluid radius_50" src="img/customers/pro_big_2.png"
                                                        alt="" />
                                                </div>
