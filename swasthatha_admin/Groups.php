            ...
            <div class="col-lg-6">
                <div class="white_card card_height_100 mb_30">
                    ...
                    <div class="white_card_body">
                        ...
                        <h6 class="card-subtitle mb-2">Place one add-on or button on either side of an input. You may
                            also place one on both sides of an input. Remember to place <code
                                class="highlighter-rouge">&lt;label&gt;</code>s outside the input group.</h6>
